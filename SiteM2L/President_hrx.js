 ...
 */
function actualiserPresident()
{
    var listePresident = requete.responseText;
    var blocListe = document.getElementById('blocPresident');
    blocListe.innerHTML = listePresident;
}
...
{
    /* Si il n'y a pas de numUo, on fait disparaître la seconde liste au cas où elle serait affichée */
    if(Id == 'vide')
    {
        document.getElementById('blocPresident').innerHTML = '';
    }
    else
    {
        /* À cet endroit précis, on peut faire apparaître un message d'attente */
        var blocPresident = document.getElementById('blocPresident');
        blocListe.innerHTML = "Traitement en cours, veuillez patienter...";
        /* On crée l'objet XHR */
        creerRequete();
        /* Définition du fichier de traitement */
        var url = 'TrouverPresident.php?Id='+ Id;
