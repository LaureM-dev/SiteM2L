 ...
 */
function actualiserDescription()
{
    var listeDescription = requete.responseText;
    var blocListe = document.getElementById('blocDescription');
    blocListe.innerHTML = listeDescription;
}
...
function getDescription(Id)
{
    ...
    if(Id == 'vide')
    {
        document.getElementById('blocDescription').innerHTML = '';
    }
    else
    {
        ...
        var url = 'trouverDescription.php?Id='+ Id;
